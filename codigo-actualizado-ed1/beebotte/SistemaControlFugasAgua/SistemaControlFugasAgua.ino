...
const char* ssid = "MOVISTAR_C928";             // SSID de la red WIFI a la que deseamos conectarnos
...
const char usuario[] = "token_Paqg2XGXHJVcBt5Q"; //Token del canal fugas de agua
